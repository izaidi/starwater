...
define(['lib/Vector'],function(Vector){
  ...
  _.extend(Particle.prototype,{
    ...
    move : function() {
      ...
      if (Pulsar.collision(this.position)) {
        this.ttl = 1;
      }
    },
    dynamicColor: function() {
      var startColor = Particle.color;
      var blue = startColor[2] * ((this.ttl - this.lived) / this.ttl);
      return [startColor[0], startColor[1], blue, startColor[3]];
    },
